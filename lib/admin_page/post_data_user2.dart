...
class PostDataUser2 extends StatefulWidget {
  PostDataUser2({Key? key,required this.idx}) : super(key: key);

  Map idx;

  @override
  State<PostDataUser2> createState() => _PostDataUser2State(this.idx);
}

class _PostDataUser2State extends State<PostDataUser2> {

  late Map idx;

  _PostDataUser2State(this.idx);
