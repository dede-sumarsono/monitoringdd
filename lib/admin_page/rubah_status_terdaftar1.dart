...
import 'package:monitoringdd/admin_page/rubah_level_user2.dart';
import 'package:monitoringdd/admin_page/rubah_status_terdaftar2.dart';
...
class RubahStatusTerdaftar1 extends StatefulWidget {
  RubahStatusTerdaftar1({Key? key}) : super(key: key);


  @override
  State<RubahStatusTerdaftar1> createState() => _RubahStatusTerdaftar1State();
}

class _RubahStatusTerdaftar1State extends State<RubahStatusTerdaftar1> {
                        ...
                        child: ListTile(
                          ...
                          onTap: (){
                            ...
                            //.push(MaterialPageRoute(builder: (context)=>PostDataUser(idx: _foundData[index]),));
                                .push(MaterialPageRoute(builder: (context)=>RubahStatusTerdaftar2(idx: _foundData[index]),));
